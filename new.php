...
<body style="background-color : lightblue;font-family: 'Markazi Text', serif;" >
  ...
  if (isset( $_GET['success_delete'] )) {
    $type = $_GET['success_delete'];

      echo "<div style=\"width : 500px; position : absolute; left : 50% ; top : 98%; transform : translate(-50% ,-98%); \" class=\"alert alert-success alert-dismissible fade in\" role=\"alert\"><strong>SUCSESS ! </strong> Sucsess_Deleted_$type <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\"><span>&times;</span></button></div>";


  }elseif (isset( $_GET['success_added'] )) {
    $type = $_GET['success_added'];

      echo "<div style=\"width : 500px; position : absolute; left : 50% ; top : 98%; transform : translate(-50% ,-98%); \" class=\"alert alert-success alert-dismissible fade in\" role=\"alert\"><strong>SUCSESS ! </strong> Sucsess_Added_$type <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\"><span>&times;</span></button></div>";


  }elseif (isset( $_GET['faild_delete'] )) {
    $type = $_GET['faild_delete'];

      echo "<div style=\"width : 500px; position : absolute; left : 50% ; top : 98%; transform : translate(-50% ,-98%); \" class=\"alert alert-dangers alert-dismissible fade in\" role=\"alert\"><strong>ERROR ! </strong> Faild_Delete_$type <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\"><span>&times;</span></button></div>";


  }elseif (isset( $_GET['faild_add'] )) {
    $type = $_GET['faild_add'];

      echo "<div style=\"width : 500px; position : absolute; left : 50% ; top : 98%; transform : translate(-50% ,-98%); \" class=\"alert alert-dangers alert-dismissible fade in\" role=\"alert\"><strong>ERROR ! </strong> Faild_Add_$type <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\"><span>&times;</span></button></div>";
...
<div class="well" id="addS" style="display: none; position : fixed; top : 50%; left: 50%; transform : translate(-50% , -50%); width : 500px;" >
  ...
  <select class="form-control" style="border : none; background-color : transparent; border-bottom: 1px solid blue;" name="category_ID">
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
         ...
         $id = $row["id"];
              ...
              echo "<option value=\"$id\">". $ar_name ."</option>";
            }
