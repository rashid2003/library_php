...
###############################################################
 -->
<div style="display:none;" id="seclist" class="sec-list">
...
<div style="display:none;" id="thlist" class="th-list">
...
<script>
function sec_open() {
  document.getElementById("seclist").style.display = "inline-block";
}
function th_open() {
  document.getElementById("thlist").style.display = "inline-block";
}
function show_pdf(){
  document.getElementById("pdf_show").style.display = "inline-block";
}
